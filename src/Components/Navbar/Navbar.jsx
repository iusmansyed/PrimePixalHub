        ...
        <div className={styles.header}>
          ...
          <div className={styles.links}>
            <ul>
              ...
              >
                <div className={styles.subLinks}>
                  <div style={navLinkStyle}>
                    Services{" "}
                    {dropdownVisible ? <AiFillCaretDown /> : <AiFillCaretUp />}
                  </div>
              ...
              <li
                style={{
                  borderBottom: item == "work" ? "1px solid red" : "",
                }}
              >
                <NavLink
                  to={"/work"}
              ...
              <li
                style={{
                  borderBottom: item == "packages" ? "1px solid red" : "",
                }}
              >
                <NavLink
                  to={"/packages"}
                  onClick={() => {
                    goTop(), setItem("packages");
                  }}
                  style={navLinkStyle}
                >
                  Packages
          ...
          <div className={styles.links2}>
            ...
            >
              <ul>
                ...
                <li>
                  <NavLink to={"/work"} onClick={goTop} style={navLinkStyle2}>
                    How We Work
                  </NavLink>
                </li>
                <li>
